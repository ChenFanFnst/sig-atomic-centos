...
logvol / --size=10000 --fstype="xfs" --name=root --vgname=atomicos

# Equivalent of %include fedora-repo.ks
ostreesetup --osname="escore-lite-host" --remote="escore-lite-host" --ref="escore-lite-host/7/x86_64/standard" --url="http://192.168.122.1:57503" --nogpg
...
# ostree remote delete escore-atomic-host
# ostree remote add --set=gpg-verify=false escore-atomic-host 'http://192.168.122.1:57503'
